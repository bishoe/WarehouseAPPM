...
namespace WarehouseAPPM
{
    public partial class FRM_Expiredproducts : MetroFramework.Forms.MetroForm
    {
        ...
        private void FRM_Expiredate_Load(object sender, EventArgs e)
        {
            ...
            {
                this.Alert("منتجات اوشكت على انتهاء صلاحيتها", Form_Alert.enmType.Info);
